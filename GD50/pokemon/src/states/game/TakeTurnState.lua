            ...
            Timer.after(1.5, function()
                ...
                :finish(function()
                    ...
                    if self.playerPokemon.currentExp > self.playerPokemon.expToLevel then
                        local currentStats = {
                            currentHP = self.playerPokemon.HP,
                            currentatk = self.playerPokemon.attack,
                            currentdef = self.playerPokemon.defense,
                            currentspd = self.playerPokemon.speed
                        }
                        ...
                        local StatsUp = {self.playerPokemon:statsLevelUp()}
                        

                        gStateStack:push(BattleMessageState('Congratulations! Level Up!',
                        function() 
                            -- push level up menu1
                            gStateStack:push(BattleVictoryMenuState(self.battleState,{ 
                                hp = currentStats.currentHP,
                                atk = currentStats.currentatk,
                                def = currentStats.currentdef,
                                spd = currentStats.currentspd 
                            }
                            ))
                            -- stay on menu for 2 seconds
                            Timer.after(2, function()
                                ...
                                Timer.after(2, function()
                                    ...
                                    gStateStack:push(BattleVictoryMenuState(self.battleState,{ 
                                        ...
                                        atk = self.playerPokemon.attack,
                                        def = self.playerPokemon.defense,
                                        spd = self.playerPokemon.speed
                                    }
                                    ))
